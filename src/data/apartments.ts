...
export const apartments: Apartment[] = [
  ...
  },
  {
    ...
    amenities: ['Play Area Access', 'Study Corner', 'Family Events'],
  ...
  },
  {
    ...
    amenities: ['Premium Play Area', 'Private Study', 'Family Dining'],
  ...
  // Block D - Community Hub (4 apartments)
  {
    ...
    amenities: ['Community Hall Access', 'Event Participation', 'Social Lounge'],
  ...
  },
  {
    ...
    amenities: ['Meeting Room Access', 'Business Lounge', 'Event Hosting'],
  ...
  },
  {
    ...
    type: '1BHK',
    accessibility: ['Elevator Access'],
    amenities: ['Community Events', 'Social Gatherings', 'Networking'],
  ...
  },
  {
    ...
    amenities: ['Premium Community Access', 'Private Events', 'Executive Lounge'],
  ...
  // Block E - Rooftop Retreat (3 apartments)
  {
    ...
    amenities: ['Rooftop Lounge Access', 'Sky Dining', 'Premium Views'],
  ...
  },
  {
    ...
    amenities: ['VIP Rooftop Access', 'Private Sky Dining', '360° Views'],
  ...
  },
  {
    ...
    amenities: ['Executive Rooftop', 'Private Terrace', 'Concierge Service'],

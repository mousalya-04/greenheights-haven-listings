...
export const apartments: Apartment[] = [
  // Block A Apartments - Unique Images for Each
  {
    id: 'a101',
    number: 'A-101',
    block: 'A',
  ...
  // Block B Apartments - All Unique Images
  {
    id: 'b101',
    number: 'B-101',
    block: 'B',
  ...
  },
  {
    ...
    images: {
      ...
      kitchen: 'https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=400&h=300&fit=crop',
  ...
  },
  {
    ...
    images: {
      ...
      balcony: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=400&h=300&fit=crop',
      bedroom: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=300&fit=crop',
      diningArea: 'https://images.unsplash.com/photo-1574180045827-681f8a1a9622?w=400&h=300&fit=crop'
    }
  },
  ...
  // Block C Apartments - All Unique Images
  {
    id: 'c101',
    number: 'C-101',
    block: 'C',
  ...
  },
  {
    ...
    sqft: 1600,
    available: true,
    description: 'Luxurious 3BHK apartment with premium amenities and city view.',
    type: '3BHK',
    furnishing: 'Fully Furnished',
    features: ['Luxury Design', 'City View', 'Premium Kitchen', 'Swimming Pool'],
    rating: 4.8,
    reviews: 22,
    uniqueFeatures: ['Top Floor', 'City View', 'Luxury Amenities'],
    accessibility: ['Premium Access', 'Elevator Access', 'Luxury Facilities'],
    images: {
      main: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=400&h=300&fit=crop',
      kitchen: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=400&h=300&fit=crop',
      livingRoom: 'https://images.unsplash.com/photo-1721322800607-8c38375eef04?w=400&h=300&fit=crop',
  ...
  },
  {
    ...
    sqft: 1900,
    available: true,
    description: 'Spacious 4BHK penthouse with luxury amenities and panoramic views.',
    type: '4BHK',
    furnishing: 'Fully Furnished',
    features: ['Penthouse Style', 'Panoramic Views', 'Luxury Kitchen', 'Private Terrace'],
    rating: 4.9,
    reviews: 18,
    uniqueFeatures: ['Penthouse', 'Panoramic Views', 'Private Terrace'],
    accessibility: ['Private Elevator', 'Luxury Access', 'Premium Facilities'],
    images: {
      main: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=400&h=300&fit=crop',
      kitchen: 'https://images.unsplash.com/photo-1588854337236-6889d631faa8?w=400&h=300&fit=crop',
      livingRoom: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=400&h=300&fit=crop',
  ...
  // Block D Apartments - Executive Suites (All Unique Images)
  {
    id: 'd101',
    number: 'D-101',
    block: 'D',
  ...
  },
  {
    ...
    sqft: 2100,
    available: true,
    description: 'Luxury executive penthouse with panoramic views and premium services.',
    type: '4BHK',
    furnishing: 'Fully Furnished',
    features: ['Penthouse Suite', 'Executive Services', 'Private Terrace', 'Butler Service'],
    rating: 4.9,
    reviews: 26,
    uniqueFeatures: ['Executive Penthouse', 'Private Terrace', 'Premium Services'],
    accessibility: ['Private Elevator', 'Executive Access', 'Premium Facilities'],
    images: {
      main: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop',
      kitchen: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=400&h=300&fit=crop',
      livingRoom: 'https://images.unsplash.com/photo-1721322800607-8c38375eef04?w=400&h=300&fit=crop',
  ...
  // Block E Apartments - Penthouse Collection (All Unique Images)
  {
    id: 'e101',
    number: 'E-101',
    block: 'E',
  ...
  },
  {
    ...
    sqft: 2400,
    available: true,
    description: 'Premium 4BHK penthouse with luxury amenities and exclusive services.',
    type: '4BHK',
    furnishing: 'Fully Furnished',
    features: ['Premium Suite', 'Sky Lounge', 'Private Terrace', 'Concierge Service'],
    rating: 4.8,
    reviews: 20,
    uniqueFeatures: ['Premium Suite', 'Sky Lounge', 'Exclusive Access'],
    accessibility: ['Private Elevator', 'Premium Parking', 'Exclusive Services'],
    images: {
      main: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=400&h=300&fit=crop',
      kitchen: 'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=400&h=300&fit=crop',
      livingRoom: 'https://images.unsplash.com/photo-1721322800607-8c38375eef04?w=400&h=300&fit=crop',
  ...
  },
  {
    ...
    sqft: 2800,
    available: true,
    description: 'Ultra-luxury 5BHK penthouse with exclusive amenities and panoramic city views.',
    type: '5BHK',
    furnishing: 'Fully Furnished',
    features: ['Ultra Luxury', 'Panoramic Views', 'Private Elevator', 'Butler Service'],
    rating: 4.9,
    reviews: 24,
    uniqueFeatures: ['Ultra Luxury', 'Panoramic Views', 'Exclusive Amenities'],
    accessibility: ['Private Elevator', 'Ultra Premium Access', 'Butler Service'],
    images: {
      main: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400&h=300&fit=crop',
      kitchen: 'https://images.unsplash.com/photo-1600489000022-c2086d79f9d4?w=400&h=300&fit=crop',
      livingRoom: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=400&h=300&fit=crop',

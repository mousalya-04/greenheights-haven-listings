...
import { MapPin, Star, Users, Home as HomeIcon, Calendar, Shield, TreePine, Sparkles, Award, CheckCircle, Building } from 'lucide-react';

const Home = () => {
  return (
    <div className="min-h-screen bg-black">
      {/* Hero Section */}
      <section className="relative h-screen bg-gradient-to-br from-black via-gray-900 to-violet-900 flex items-center overflow-hidden">
        <div 
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-10 w-16 h-16 bg-violet-500 rounded-full opacity-20 animate-bounce"></div>
          <div className="absolute top-40 right-20 w-12 h-12 bg-violet-400 rounded-full opacity-25 animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-40 w-20 h-20 bg-gray-700 rounded-full opacity-15 animate-bounce delay-500"></div>
          <div className="absolute top-60 left-1/3 w-8 h-8 bg-violet-600 rounded-full opacity-30 animate-pulse delay-2000"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="mb-6">
            <div className="inline-flex items-center justify-center w-28 h-28 bg-gradient-to-r from-violet-500 via-violet-600 to-violet-700 rounded-full shadow-2xl mb-4 animate-pulse-violet">
              <Building className="text-white" size={40} />
            </div>
            <div className="flex justify-center mb-3">
              <Sparkles className="text-violet-300 animate-pulse" size={24} />
              <Sparkles className="text-violet-400 animate-pulse delay-500 mx-2" size={20} />
              <Sparkles className="text-violet-500 animate-pulse delay-1000" size={24} />
            </div>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-playfair font-bold mb-4 gradient-text animate-fade-in neon-violet">
            MR Residencies
          </h1>
          <p className="text-lg md:text-xl mb-3 text-violet-200 font-poppins font-semibold">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <Link 
              to="/apartments" 
              className="bg-gradient-to-r from-violet-500 to-violet-600 hover:from-violet-600 hover:to-violet-700 text-white px-8 py-4 rounded-2xl text-lg font-poppins font-bold transition-all transform hover:scale-110 shadow-2xl border border-violet-400"
            >
              🏠 Explore Apartments
            </Link>
            <Link 
            ...
            <Link 
              to="/facilities" 
              className="bg-gradient-to-r from-black to-gray-900 hover:from-gray-900 hover:to-black text-white px-8 py-4 rounded-2xl text-lg font-poppins font-bold transition-all transform hover:scale-110 shadow-2xl border border-violet-500"
            >
              🎯 View Facilities
            </Link>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <div className="flex items-center glass-effect px-4 py-2 rounded-full border border-violet-500/30">
              <Award className="text-violet-400 mr-2" size={18} />
              <span className="font-poppins">Award Winning</span>
            </div>
            <div className="flex items-center glass-effect px-4 py-2 rounded-full border border-violet-500/30">
              <Shield className="text-violet-400 mr-2" size={18} />
              <span className="font-poppins">100% Safe</span>
            </div>
            <div className="flex items-center glass-effect px-4 py-2 rounded-full border border-violet-500/30">
              <CheckCircle className="text-violet-400 mr-2" size={18} />
      ...
      {/* Stats Section */}
      <section className="py-16 bg-gradient-to-br from-gray-900 via-black to-violet-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold gradient-text mb-3 neon-violet">
              ✨ Why Choose MR Residencies? ✨
            </h2>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="card-glass p-6 rounded-3xl hover:shadow-violet-500/30 transition-all duration-300 transform hover:scale-105">
              <HomeIcon className="mx-auto text-violet-400 mb-3 animate-bounce" size={40} />
              ...
              <p className="text-xs text-violet-300 mt-1">🏠 Luxury Spaces</p>
            </div>
            
            <div className="card-glass p-6 rounded-3xl hover:shadow-violet-500/30 transition-all duration-300 transform hover:scale-105">
              <Users className="mx-auto text-violet-400 mb-3 animate-bounce delay-300" size={40} />
              ...
              <p className="text-xs text-violet-300 mt-1">👨‍👩‍👧‍👦 Community</p>
            </div>
            
            <div className="card-glass p-6 rounded-3xl hover:shadow-violet-500/30 transition-all duration-300 transform hover:scale-105">
              <Star className="mx-auto text-violet-400 mb-3 fill-current animate-bounce delay-500" size={40} />
              ...
              <p className="text-xs text-violet-300 mt-1">⭐ Excellence</p>
            </div>
            
            <div className="card-glass p-6 rounded-3xl hover:shadow-violet-500/30 transition-all duration-300 transform hover:scale-105">
              <MapPin className="mx-auto text-violet-400 mb-3 animate-bounce delay-700" size={40} />
              ...
              <p className="text-xs text-violet-300 mt-1">🏢 Architecture</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-playfair font-bold gradient-text mb-4 neon-violet">
              🏰 Our Premium Blocks 🏰
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link to="/block/A" className="group">
              <div className="card-modern overflow-hidden hover:shadow-violet-500/30 transition-all duration-500 transform hover:scale-105">
                <div className="h-64 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="w-12 h-12 bg-violet-500 rounded-full flex items-center justify-center mb-2 shadow-lg">
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="bg-violet-500/80 text-white px-3 py-1 rounded-full text-xs font-poppins font-bold">
                      🌱 Eco-Friendly
                    </span>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-playfair font-bold mb-2 group-hover:text-violet-400 transition-colors text-white">
                    Block A - Garden Paradise 🌺
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🌿 Rooftop Garden</span>
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🥕 Organic Farm</span>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/block/B" className="group">
              <div className="card-modern overflow-hidden hover:shadow-violet-500/30 transition-all duration-500 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🏋️ Modern Gym</span>
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🧘 Yoga Studio</span>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/block/C" className="group">
              <div className="card-modern overflow-hidden hover:shadow-violet-500/30 transition-all duration-500 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🎪 Kids Playground</span>
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🏠 Family Lounge</span>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/block/D" className="group">
              <div className="card-modern overflow-hidden hover:shadow-violet-500/30 transition-all duration-500 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🎭 Event Hall</span>
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">☕ Social Lounge</span>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/block/E" className="group">
              <div className="card-modern overflow-hidden hover:shadow-violet-500/30 transition-all duration-500 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🍽️ Sky Dining</span>
                    <span className="px-3 py-1 bg-gray-800/50 text-violet-300 rounded-full text-xs font-poppins font-semibold">🌆 City Views</span>
                  </div>
                </div>
              </div>
            </Link>
      ...
      {/* Why Choose Us */}
      <section className="py-16 bg-gradient-to-r from-gray-900 via-black to-violet-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold gradient-text mb-4 neon-violet">
              🌟 Why Choose Us? 🌟
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center card-glass p-6 rounded-3xl hover:shadow-violet-500/20 transition-all transform hover:scale-105">
              <div className="w-12 h-12 bg-gradient-to-r from-violet-500 to-violet-600 rounded-full flex items-center justify-center mx-auto mb-3">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-black via-gray-900 to-violet-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/apartments" 
              className="bg-gradient-to-r from-violet-500 to-violet-600 text-white px-8 py-4 rounded-2xl font-poppins font-bold text-lg hover:from-violet-600 hover:to-violet-700 transition-all transform hover:scale-105 shadow-2xl"
            >
              🏠 View Apartments
            </Link>
            <Link 
              to="/schedule-visit" 
              className="border-2 border-violet-500 text-violet-400 px-8 py-4 rounded-2xl font-poppins font-bold text-lg hover:bg-violet-500 hover:text-white transition-all transform hover:scale-105"
            >
              📅 Schedule Visit
            </Link>
          </div>

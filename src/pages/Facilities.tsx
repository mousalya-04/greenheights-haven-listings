  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-stone-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-slate-600 to-slate-700 rounded-2xl text-white text-center py-16 mt-20 shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a 
              href="/apartments" 
              className="bg-white text-slate-800 px-10 py-4 rounded-xl font-semibold hover:bg-slate-50 transition-colors shadow-lg"
            >
              Browse Apartments
            </a>
            <a 

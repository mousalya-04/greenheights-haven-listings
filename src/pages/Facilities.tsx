  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-stone-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {category.items.map((facility, facilityIndex) => (
                  <Link
                    ...
                    className="group bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:scale-105 border border-orange-200"
                  >
                    <div className="text-center">
                      <div className="w-20 h-20 bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:from-orange-200 group-hover:to-orange-300 transition-all duration-300">
                        <span className="text-4xl">{facility.icon}</span>
                      </div>
                      <h3 className="text-xl font-semibold text-stone-900 mb-3 group-hover:text-orange-700 transition-colors">
                        {facility.name}
                      </h3>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-2xl text-white text-center py-16 mt-20 shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a 
              href="/apartments" 
              className="bg-white text-orange-800 px-10 py-4 rounded-xl font-semibold hover:bg-orange-50 transition-colors shadow-lg"
            >
              Browse Apartments
            </a>
            <a 
              href="/contact" 
              className="border-2 border-white text-white px-10 py-4 rounded-xl font-semibold hover:bg-white hover:text-orange-800 transition-colors"
            >
              Schedule a Visit
            </a>
          </div>
